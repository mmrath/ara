...
use ara_model::core::{create_notification, Body, NewNotification, NotificationType, UserCredential, UserRecord};
...
pub fn sign_up(context: &dyn PlainContext, user_ac: &UserSignUp) -> Result<UserRecord, SignUpError> {
    tx(context.db(), |conn| {
...
fn send_activation_email(conn: &Connection, user: &UserRecord, email_body: String) -> Result<(), Error> {
