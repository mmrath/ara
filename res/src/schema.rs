...
table! {
    user_group_role (group_id, role_id) {
        group_id -> Int4,
        role_id -> Int4,
    }
}
...
table! {
    user_group_user (group_id, user_id) {
        group_id -> Int4,
        user_id -> Int8,
    }
}
...
joinable!(user_group_role -> role (role_id));
joinable!(user_group_role -> user_group (group_id));
joinable!(user_group_user -> app_user (user_id));
joinable!(user_group_user -> user_group (group_id));
